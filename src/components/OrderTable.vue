<template>
  <div class="tableContainer">
    <el-scrollbar>
      <el-table :data="pageList" ref="singleTable" highlight-current-row @current-change="handleCurrentChange" style="width: 100%;" :cell-style="{border:'none'}" :header-cell-style="{border:'none'}">
    ...
    <el-pagination background layout="prev, pager, next" :total="list.length" :current-page.sync="currentPage" @current-change="pageHandler">
    </el-pagination>
  </div>
</template>
